...
public final class SkillExpNotifierFabric implements ModInitializer {
    ...
    private void registerPackets(){
        ...
        PayloadTypeRegistry.clientboundPlay().register(XpGainPayload.ID,XpGainPayload.CODEC);
    }

    public static void sendXpGainPacket(ServerPlayer player, XpGainPayload payload) {
